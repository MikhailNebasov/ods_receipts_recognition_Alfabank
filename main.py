...
# Result preparation
Out1 = [LY1[predicted1[i]] if LY1[predicted1[i]] != 'none' else  N_value for i in range(len(df_test))]
Out2 = [LY2[predicted2[i]] if LY2[predicted2[i]] != 'none' else  N_value for i in range(len(df_test))]
